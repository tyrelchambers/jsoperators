...
import {
  operators
} from "/build/_shared/chunk-VYDO2NIP.js";
import {
  Link,
  __commonJS,
  __toESM,
...
var meta = ({ data, params }) => {
  if (!data) {
    return {
      title: "Missing Shake",
      description: `There is no shake with the ID of ${params.shakeId}. \u{1F622}`
    };
  }
  const { shake } = data;
  return {
...
var _Operator = () => {
  ...
  const Component = import_react3.default.useMemo(
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
            className: "prose",
            children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Component, {}, void 0, false, {
              fileName: "app/routes/operator.$name.tsx",
              lineNumber: 66,
              columnNumber: 11
            }, this)
...
var operator_name_default = _Operator;
export {
 ...
 */
//# sourceMappingURL=/build/routes/operator.$name-DQRY4HIH.js.map
